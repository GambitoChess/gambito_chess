...
class Scacchiera(): #scrivo la mia matriciona, i nomi dei pezzi sono i nomi delle immagini da caricare
	...
	def gestisciMossa(self, mossa):
		#funzione a cui si passa il pezzo mosso e la mossa, dentro a questa funzione si possono inserire tutte le logiche di ciascuna mossa.
	...
	def mossaValida(self, mossa): #controllo che il pezzo selezionato possa muovere come indicato
		...
		risposta = False #sarà il discrimante, dove viene trovata una mossa valida è impostato a True
